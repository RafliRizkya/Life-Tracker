...
import { REFLECTION_TEMPLATES } from "@/lib/seed";
import { reflectionInsights } from "@/lib/insights";
import { formatDateID, MONTHS_ID_LONG } from "@/lib/format";
    ...
    <div className="max-w-4xl mx-auto px-5 md:px-8 pt-10 pb-24">
      ...
      >
        <div className="eyebrow flex items-center gap-1.5">
          <Compass className="h-3 w-3" /> Life Compass · Privat
        </div>
        ...
        <p className="text-[14px] text-ink-muted mt-4 max-w-lg leading-relaxed font-reflect italic">
          Ruang ini bukan untuk menghakimi. Ia untuk mengakui kerja kerasmu, menyadari kondisi
          saat ini, lalu memilih satu arah kecil untuk minggu depan.
        </p>
      </motion.header>
